...
public static class DatabaseSeeder
{
    public static async Task SeedAsync(AppDbContext db, CancellationToken cancellationToken = default)
    {
        ...
        {
            db.Plans.AddRange(
                SubscriptionPlan.Create("STARTER", "Starter", 2999m, 1, false, 1, 5, 2, 25),
                SubscriptionPlan.Create("GROWTH", "Growth", 6999m, 3, false, 2, 15, 10, 150),
                SubscriptionPlan.Create("BUSINESS", "Business", 14999m, 10, false, 3, 50, 30, 750),
                SubscriptionPlan.Create("AGENCY", "Agency", 29999m, 100, true, 4, 500, 200, 10000));
        }
