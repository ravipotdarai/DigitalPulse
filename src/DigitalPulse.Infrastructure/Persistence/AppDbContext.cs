...
public sealed class AppDbContext : DbContext, IAppDbContext
{
    ...
    public DbSet<ContentItemMedia> ContentItemMedia => Set<ContentItemMedia>();
    public DbSet<ContentSeoAnalysis> ContentSeoAnalyses => Set<ContentSeoAnalysis>();
    public DbSet<ContentTopic> ContentTopics => Set<ContentTopic>();
    public DbSet<ContentOpportunity> ContentOpportunities => Set<ContentOpportunity>();
    public DbSet<ContentCalendarEntry> ContentCalendar => Set<ContentCalendarEntry>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ApplyTenantFilter<ContentCategory>(modelBuilder);
        ApplyTenantFilter<ContentTag>(modelBuilder);
        ApplyTenantFilter<ContentItemCategory>(modelBuilder);
        ApplyTenantFilter<ContentItemTag>(modelBuilder);
        ApplyTenantFilter<ContentRevision>(modelBuilder);
        ApplyTenantFilter<ContentItemMedia>(modelBuilder);
        ApplyTenantFilter<ContentSeoAnalysis>(modelBuilder);
        ApplyTenantFilter<ContentTopic>(modelBuilder);
        ApplyTenantFilter<ContentOpportunity>(modelBuilder);
        ApplyTenantFilter<ContentCalendarEntry>(modelBuilder);
        ApplyTenantFilter<ContentDistribution>(modelBuilder);
        ApplyTenantFilter<ContentMetric>(modelBuilder);
